  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
      ...
      <main className="relative z-10 pt-24 px-4 pb-10 max-w-2xl mx-auto">
        ...
        <div className="bg-white/[0.03] border border-ink/10 rounded-3xl p-6">
          {error && <p className="text-pink-400 text-sm mb-4">{error}</p>}

          <div className="mb-4">
            <label className="text-xs text-ink/30 mb-1 block">Pen name</label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="text-xs text-ink/30 mb-1 block">Writer profile picture (optional)</label>
            <p className="text-xs text-ink/20 mb-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <label className="px-4 py-2 bg-white/5 border border-ink/10 hover:border-violet-500/40 text-ink/70 hover:text-violet-400 rounded-xl text-sm cursor-pointer transition">
          ...
          <div className="mb-6">
            <label className="text-xs text-ink/30 mb-1 block">Bio (optional)</label>
            <textarea
