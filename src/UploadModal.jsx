                ...
                {expandedIndex === i && (
                  <div className="px-3 pb-3 pt-1 border-t border-white/5 bg-white/[0.02] space-y-2">
                    ...
                    <select
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-2 text-sm text-white/70 outline-none focus:border-violet-500/60 transition"
                    >
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder-white/20 outline-none focus:border-violet-500/60 resize-none transition"
                    />
                  </div>
                )}
              </div>
